...
//	html += _mp.create.Blocks();
	...
	_mp.project.createNew("New Project",64,256,"/wp-content/js/images/tile-game-1.png",0);
};
...
_mp.getPromptResults = function(){
	if(($('.PromptBox'))){var PromptResult = 'PromptResult = {';
...
_mp.project.createNewButton = function(){
		_mp.prompt({"Project Name (String)" : "New Project", "Tile Size (Int)" : 64, "Tile Set Tile Count (Int)" : 256, "Tile Set Url (String)" : "/wp-content/js/images/tile-game-1.png", "Air Tile (Int)" : 0}, "_mp.project.createNew()", "Warning! This Replaces The Current Project.");
}
